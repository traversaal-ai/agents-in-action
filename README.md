...
| 3 | Welcome to n8n - AI Workflow Automation Platform | Set up and explore n8n as your no-code environment for building AI agents. Learn how to integrate APIs, connect services, and visualize workflows — all without writing a single line of code. | Get to know n8n, the open-source automation platform that powers your AI workflows. Understand its interface, triggers, nodes, and how it becomes the perfect no-code playground for building your first AI agent. |
|  | 3a. [n8n - Your No-Code Platform for Building AI Agents](https://aminajavaid30.github.io/agents-in-action/meet-n8n/) |  |  |
